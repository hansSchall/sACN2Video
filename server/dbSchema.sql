...
CREATE TABLE IF NOT EXISTS config_osc (ip TEXT, port number);
CREATE TABLE IF NOT EXISTS els (id text,type text,enabled NUMBER DEFAULT 1, zi FLOAT DEFAULT 0,PRIMARY KEY(id));
